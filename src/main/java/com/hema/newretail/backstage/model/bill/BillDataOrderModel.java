...
import com.hema.newretail.backstage.entry.orderentry.OrdersData;
 ...
 */
public class BillDataOrderModel implements Serializable {
    ...
    private List<OrdersData> orders111;

    public List<OrdersData> getOrders111() {
        return orders111;
    }

    public void setOrders111(List<OrdersData> orders111) {
        this.orders111 = orders111;
    }
